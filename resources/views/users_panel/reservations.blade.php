    ...
    <section class="left-container">
        ...
        <form action="{{ route('reservation.store', $charger->id) }}" method="post">
            ...
            <p id="capacity_section" style="display:none;">
                ...
                <br>
                <input type="number" step="1" name="battery_capacity" id="battery_capacity">
            </p>

            <p id="charging_time_section" style="display:none;">
        ...
        <script>
            ...
            document.getElementById('reservation_type').addEventListener('change', function() {
                ...
                var chargingtimeSection = document.getElementById('charging_time_section');
                var chargingTimeInput = document.getElementById('charging_time');
                var endTimeField = document.getElementById('end_time');

                if (this.value === 'capacity') {
                    capacitySection.style.display = 'block';
                    chargingtimeSection.style.display = 'block';
                    ...
                    chargingtimeSection.style.display = 'none';
