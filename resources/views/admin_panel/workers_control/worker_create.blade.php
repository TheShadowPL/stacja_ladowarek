...
<div class="container">
    ...
    <form action="{{ route('admin.worker.store') }}" method="post">
        ...
        @endif
        <br>
        <label for="password">Hasło Pracownika</label>
        ...
        <br>
        <label for="first_name">Imię Pracownika</label>
        <input type="text" class="form-control" name="first_name" id="first_name">
        <br>
        <label for="last_name">Nazwisko Pracownika</label>
        <input type="text" class="form-control" name="last_name" id="last_name">
        <br>
        <label for="dob">Data urodzenia Pracownika </label>
        <input type="date" class="form-control" name="dob" id="dob">
        <br>
        <label for="phone_number">Numer Telefonu Pracownika</label>
