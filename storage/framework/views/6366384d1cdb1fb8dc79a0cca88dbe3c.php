...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/index/chargers-list-style.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/index/filters-style.css')); ?>">
    ...
    <body>
        <section class="filters">
            <form>
                ...
                <div class="input">
                    <label for="brand" class="input-title"
                        >Marka ładowarki</label
                    >
            ...
            <div
                ...
                "
            >
                <a href="<?php echo e(route('malfunction')); ?>">Zgłoś awarię</a>
            </div>
        </section>
        <section class="container">
            ...
            <table class="charger-list">
                ...
                <?php $__currentLoopData = $chargers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($charger->status == 'available'): ?>
                        <?php $charger->distance = 0.0; ?>
                    <?php else: ?>
                        <?php $charger->distance = 21.37; ?>
                    <?php endif; ?>
                    <tr class="charger">
                        <td class="charger-<?php echo e(strtolower($charger->status)); ?>"><?php echo e($charger->status); ?></td>
                        <td>
                            <div class="charger-localisation">
                                <div><?php echo e($charger->distance); ?> km</div>
                                <div class="separator"></div>
                                <div>
                                    <b><?php echo e($charger->city); ?></b><br />
                                    ul. <?php echo e($charger->street); ?> <?php echo e($charger->number); ?>

                                </div>
                            </div>
                        </td>
                        <td class="charger-price"><?php echo e($charger->price); ?></td>
                        <td>
                            <?php if($charger->closestTerm_date && $charger->closestTerm_time): ?>
                                <?php echo e($charger->closestTerm_date); ?> <?php echo e($charger->closestTerm_time); ?>
                        ...
                        <td>
                            <a href="<?php echo e(route('reservation', ['charger_id' => $charger->id])); ?>">
                                <svg
                                    width="33"
                                    height="34"
                                    viewBox="0 0 33 34"
                                ...
                                >
                                    <ellipse
                                        ...
                                        rx="12.8"
                                        ry="12.8"
                                        transform="matrix(4.37114e-08 -1 -1 -4.37114e-08 32 29.8)"
                                        fill="#7E869E"
                                        fill-opacity="0.25"
                                    />
                                    <path
                                        d="M5.9 17C5.9 9.6546 11.8546 3.69999 19.2 3.69999C26.5454 3.69999 32.5 9.6546 32.5 17C32.5 24.3454 26.5454 30.3 19.2 30.3C11.8546 30.3 5.9 24.3454 5.9 17Z"
                                        stroke="#7E869E"
                                        stroke-opacity="0.25"
                                    />
                                    <path
                                        d="M4.68629 28.3137C6.92393 30.5513 9.77486 32.0752 12.8786 32.6926C15.9823 33.3099 19.1993 32.9931 22.1229 31.7821C25.0466 30.5711 27.5454 28.5203 29.3035 25.8891C31.0616 23.2579 32 20.1645 32 17C32 13.8355 31.0616 10.7421 29.3035 8.11088C27.5454 5.47969 25.0466 3.42893 22.1229 2.21793C19.1993 1.00693 15.9823 0.690072 12.8786 1.30744C9.77486 1.9248 6.92393 3.44865 4.68629 5.68629"
                                        stroke="#153131"
                                        stroke-width="2"
                                    />
                                    <path
                                        d="M20.8 17L21.5809 16.3753L22.0806 17L21.5809 17.6247L20.8 17ZM1.59999 18C1.0477 18 0.599987 17.5523 0.599987 17C0.599987 16.4477 1.0477 16 1.59999 16V18ZM15.1809 8.3753L21.5809 16.3753L20.0191 17.6247L13.6191 9.6247L15.1809 8.3753ZM21.5809 17.6247L15.1809 25.6247L13.6191 24.3753L20.0191 16.3753L21.5809 17.6247ZM20.8 18H1.59999V16H20.8V18Z"
                                        fill="#153131"
                                    />
                                </svg>
                            </a>
...
<?php /**PATH C:\Users\Krystian\Desktop\stacja_ladowarek\stacja_ladowarek\resources\views/ladowarki1.blade.php ENDPATH**/ ?>